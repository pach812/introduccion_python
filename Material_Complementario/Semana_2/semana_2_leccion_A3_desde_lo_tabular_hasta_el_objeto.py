...
def _(patients, visits):
    ...
    summary_tabular
    return bins, labels, summary_tabular
...
def _():
    ...
    try: 
        ...
        print("Error al normalizar las columnas", norm.columns.values)
    return
...
@app.cell
def _(ClinicalCohort, cohort_obj):
    # Hidden checks (do not modify)
...
@app.cell
def _(ClinicalCohort, Dict, List, Optional, dataclass):
    @dataclass
