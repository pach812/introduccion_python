...
def _():
    ...
    return dataclass, platform, sys


@app.cell
def _(dataclass, platform, sys):
    ...
    return EnvironmentInfo, env_info, get_environment_info


@app.cell
def _(mo):
    mo.md("# Pre–Sesión 1 — Primer contacto con Python (marimo)")
    return
...
@app.cell
def _(env_info, mo):
    mo.md("## Verificación del entorno (evidencia técnica)")
    mo.md(
        f"""
...
"""
    ...
    return example_bool, example_float, example_int, example_str
...
"""
    ...
    return combined_xy, final_value, op, pre_session_1_result, safe_combine, x, y, z
